            ...
            <div className='w-[80vw] h-auto flex flex-wrap justify-center items-center gap-4'>
              {skills.map((skill, index) => (
                <Tilt
                  ...
                  className='xl:h-58 lg:h-50 md:h-50 flex flex-col bg-purple-200/50 items-center justify-around rounded-lg border border-black shadow-lg aspect-square py-8
