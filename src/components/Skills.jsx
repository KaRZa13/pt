    ...
    <section className='w-screen h-screen flex flex-col justify-around items-center mb-[50vh] font-grotesk'>
      ...
      <div ref={skillsRef}>
        <ContentScroll
          ...
          threshold={0.2}
        >
          <div className='max-w-[85vw] h-auto flex flex-wrap justify-center items-center gap-4'>
            {skills.map((skill, index) => (
              <Tilt
                key={index}
                tiltMaxAngleX={maxAngle}
                tiltMaxAngleY={maxAngle}
                className='h-48 flex flex-col bg-purple-200/50 items-center justify-around rounded-lg border border-black shadow-lg aspect-square py-8
